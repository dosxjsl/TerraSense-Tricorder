...
/* CLK1 */
#define CLK1__DIV_IDX 5
#define CLK1__DIV_NUM 5
#define CLK1__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* CLK2 */
#define CLK2__DIV_IDX 3
#define CLK2__DIV_NUM 3
#define CLK2__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* CLK3 */
#define CLK3__DIV_IDX 4
#define CLK3__DIV_NUM 4
#define CLK3__DIV_TYPE CY_SYSCLK_DIV_8_BIT
...
/* PWM_1 */
#define PWM_1_TCPWM__CNT_HW TCPWM0_CNT5
#define PWM_1_TCPWM__CNT_IDX 5u
...
/* PWM_3 */
#define PWM_3_TCPWM__CNT_HW TCPWM0_CNT6
#define PWM_3_TCPWM__CNT_IDX 6u
#define PWM_3_TCPWM__HW TCPWM0
#define PWM_3_TCPWM__IDX 0u

/* PWM_4 */
#define PWM_4_TCPWM__CNT_HW TCPWM0_CNT7
#define PWM_4_TCPWM__CNT_IDX 7u
#define PWM_4_TCPWM__HW TCPWM0
#define PWM_4_TCPWM__IDX 0u

/* PWM_5 */
#define PWM_5_TCPWM__CNT_HW TCPWM1_CNT0
#define PWM_5_TCPWM__CNT_IDX 0u
#define PWM_5_TCPWM__HW TCPWM1
#define PWM_5_TCPWM__IDX 1u

/* PWM_6 */
#define PWM_6_TCPWM__CNT_HW TCPWM0_CNT0
#define PWM_6_TCPWM__CNT_IDX 0u
#define PWM_6_TCPWM__HW TCPWM0
#define PWM_6_TCPWM__IDX 0u

/* PWM_7 */
#define PWM_7_TCPWM__CNT_HW TCPWM0_CNT1
#define PWM_7_TCPWM__CNT_IDX 1u
#define PWM_7_TCPWM__HW TCPWM0
#define PWM_7_TCPWM__IDX 0u

/* PWM_8 */
#define PWM_8_TCPWM__CNT_HW TCPWM0_CNT4
#define PWM_8_TCPWM__CNT_IDX 4u
#define PWM_8_TCPWM__HW TCPWM0
#define PWM_8_TCPWM__IDX 0u

/* PWM_9 */
#define PWM_9_TCPWM__CNT_HW TCPWM0_CNT2
#define PWM_9_TCPWM__CNT_IDX 2u
#define PWM_9_TCPWM__HW TCPWM0
#define PWM_9_TCPWM__IDX 0u
...
#define CY_PROJECT_NAME "Tricorder"
